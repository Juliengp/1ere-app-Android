...
@Composable
fun SeriesDetails(seriesId: String, viewModel: MainViewModel = viewModel(), navController: NavController) {
    viewModel.getSerieDetails(seriesId)
    viewModel.getSeriesActors(seriesId)
    val series = viewModel.serieDetails.collectAsState().value
